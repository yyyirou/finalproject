...
//Step 4: 執行 SQL 指令, 只有一筆資料          
			...
			sql = "SELECT * FROM `pro_detail` WHERE `pdid` = 'P013'";
			rs=con.createStatement().executeQuery(sql);
//Step 5: 顯示結果            
		   int inventory = 0;
    ...
    <main>
        ...
        <div class="info">
            ...
            <div class="love">
                <a href="like.jsp?data=P013" style="text-decoration: none !important;position: relative;z-index: 2;">
             ...
             <form action="shop_record.jsp" method="post">
			  <input type="hidden" name="phone" value="Pixel 6a">
			<div>
            ...
            <fieldset class="reviewbroad">
				...
				<script>
                    ...
                    <form action="review_board.jsp" method="get" >
						<input type="hidden" name="p_name" value="6a">
