...
<html>
	<head>
		...
		<link rel="stylesheet" href="assets/css/sellerdel_all.css">
		...
		<div id="page-wrapper">
			...
			<header id="header" class="">
				...
				<div style=" position: absolute; z-index:200 ">
					...
					<div class="sidebar">
					<a href="seller_index.html" class="active" target="_blank">
							<i class="fa-solid fa-house"></i>
							<span>Home</span>
					</a>
			
					<a href="selleron_all.jsp" target="_blank">
						<i class="fa-brands fa-apple"></i>
					  <span>上架商品</span>
					</a>
			
					<a href="sellerdel_all.jsp" target="_blank">
						<i class="fa-brands fa-google"></i>
					  <span>下架商品</span>
					</a>
			
					<a href="newseller.html" target="_blank">
			...
			<main class="main">
				<section class="card" style="position: relative;top: 15%;">
					...
					<h1>iphone11</h1>
					<a href="seller_i11del.jsp" target="_blank">
				...
				<section class="card">
					...
					<h1>iphone12</h1>
					<a href="seller_i12del.jsp" target="_blank">
					<i class="fa-solid fa-arrow-right" id="iconarrow" ></i>
					</a>
				</section>
				...
				<section class="card">
					...
					<h1>iphone13</h1>
					<a href="seller_i13del.jsp" target="_blank">
					<i class="fa-solid fa-arrow-right" id="iconarrow" ></i>
					</a>
				</section>
		
				<section class="card">
					<img class="i14" src="images/yi/apple/i12/IMG_3446.png" alt="i14">
					<h1>iphone14</h1>
					<a href="seller_i14del.jsp" target="_blank">
					<i class="fa-solid fa-arrow-right" id="iconarrow" ></i>
					</a>
				</section>	
				...
				<section class="card" style="position: relative;top: 15%;">
					...
					<h1>Reno8 Z</h1>
					<a href="seller_reno8zdel.jsp">
					<i class="fa-solid fa-arrow-right" id="iconarrow" ></i>
					</a>
				</section>

				<section class="card"  style="position: relative;top: 12%;">
					<img class="IV" src="images/yi/Sony/1IV/IMG_3491-removebg-preview.png" alt="1IV">
					<h1>1IV</h1>
					<a href="seller_1IVdel.jsp" target="_blank">
					<i class="fa-solid fa-arrow-right" id="iconarrow" ></i>
					</a>
				</section>
				...
				<section class="card"  style="position: relative;top: 12%;">
					...
					<h1>1V</h1>
					<a href="seller_1Vdel.jsp" target="_blank">
					<i class="fa-solid fa-arrow-right" id="iconarrow" ></i>
					</a>
				</section>
				...
				<section class="card">
					...
					<h1 >10III</h1>
					<a href="seller_10IIIdel.jsp" target="_blank">
					<i class="fa-solid fa-arrow-right" id="iconarrow" ></i>
					</a>
				</section>
				...
				<section class="card">
					...
					<h1>10V</h1>
					<a href="seller_10Vdel.jsp" target="_blank">
					<i class="fa-solid fa-arrow-right" id="iconarrow" ></i>
					</a>
				</section>

				<section class="card">
					<img class="a6" src="images/yi/Pixel/6a/IMG_3511-removebg-preview.png" alt="6a">
					<h1>6a</h1>
					<a href="seller_6adel.jsp" target="_blank">
					<i class="fa-solid fa-arrow-right" id="iconarrow" ></i>
					</a>
				</section>
		
				<section class="card">
					<img class="p7" src="images/yi/Pixel/7/003-removebg-preview.png" alt="7" style="position: relative;top: 3%;">
					<h1>7</h1>
					<a href="seller_7del.jsp" target="_blank">
					<i class="fa-solid fa-arrow-right" id="iconarrow" ></i>
					</a>
				</section>
		
				<section class="card">
					<img class="pro" src="images/yi/Pixel/7 pro/002-removebg-preview.png" alt="7 pro">
					<h1>7 pro</h1>
					<a href="seller_7prodel.jsp" target="_blank">
					<i class="fa-solid fa-arrow-right" id="iconarrow" ></i>
					</a>
				</section>
		
				<section class="card">
					<img class="a7" src="images/yi/Pixel/7a/001-removebg-preview.png" alt="7a">
					<h1>7a</h1>
					<a href="seller_7adel.jsp" target="_blank">
					<i class="fa-solid fa-arrow-right" id="iconarrow" ></i>
					</a>
				</section>
			</main>
