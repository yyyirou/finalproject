...
//Step 4: 執行 SQL 指令, 只有一筆資料          
			...
			sql = "SELECT * FROM `pro_detail` WHERE `pdid` = 'P015'";
			rs=con.createStatement().executeQuery(sql);
//Step 5: 顯示結果            
		   int inventory = 0;
    ...
    <main>
        ...
        <div class="info">
            ...
            <div class="love">
                <a href="like.jsp?data=P015" style="text-decoration: none !important;position: relative;z-index: 2;">
...
//Step 4: 執行 SQL 指令, 若要操作記錄集, 需使用executeQuery, 才能傳回ResultSet	
           sql="SELECT * FROM `board` WHERE board.product='7pro'"; 
            ...
            <fieldset class="reviewbroad">
				...
				<script>
                    ...
                    <form action="review_board.jsp" method="get" >
						<input type="hidden" name="p_name" value="7pro">
