...
//Step 4: 執行 SQL 指令, 只有一筆資料          
			sql = "SELECT * FROM `products` WHERE `pdid` = 'P012'";
			...
			sql = "SELECT * FROM `pro_detail` WHERE `pdid` = 'P012'";
			rs=con.createStatement().executeQuery(sql);
//Step 5: 顯示結果            
		   int inventory = 0;
    ...
    <main>
        ...
        <div class="info">
            ...
            <div class="love">
                <a href="like.jsp?data=P012" style="text-decoration: none !important;position: relative;z-index: 2;">
					<img class="heart" src="images/yi/icon/heart.png" alt="加入最愛"/>
				</a>
            </div>
			
			<form action="shop_record.jsp" method="post">
			  <input type="hidden" name="phone" value="SONY_10V">
            <div>
...
//Step 4: 執行 SQL 指令, 若要操作記錄集, 需使用executeQuery, 才能傳回ResultSet	
           sql="SELECT * FROM `board` WHERE board.product='10V'"; 
            ...
            <fieldset class="reviewbroad">
				...
				<script>
                    ...
                    <form action="review_board.jsp" method="get" >
						<input type="hidden" name="p_name" value="10V">
