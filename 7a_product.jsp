...
//Step 5: 顯示結果            
    ...
    <main>
        ...
        <div class="info">
            ...
            <div class="love">
                <a href="like.jsp?data=P016" style="text-decoration: none !important;position: relative;z-index: 2;">
...
//Step 4: 執行 SQL 指令, 若要操作記錄集, 需使用executeQuery, 才能傳回ResultSet	
           sql="SELECT * FROM `board` WHERE board.product='7a'"; 
            ...
            <fieldset class="reviewbroad">
				...
				<script>
                    ...
                    <form action="review_board.jsp" method="get" >
						<input type="hidden" name="p_name" value="7a">
